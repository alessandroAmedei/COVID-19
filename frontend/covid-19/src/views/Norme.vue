<template>
  <v-content>
    <v-container fluid>
        <h2>Norme da attuare</h2>
      <br />
      <div v-for="(item,i) in items" :key="i">
        <v-card max-width="500" elevation="12" class="card">
          <v-container fluid>
            ...
            <v-row align="center" justify="center">
              <v-col style="padding-right:0px;" cols="8">
                <v-card-subtitle>{{item.text}}</v-card-subtitle>
                <v-card-text></v-card-text>
              </v-col>
              <v-col style="padding-left:0px;" cols="4">
...
export default {
  data() {
    return {
      items: [
        {
          title: "1. Lavaggio delle mani",
          text:
            "Lavati spesso le mani con acqua e sapone o usa un gel a base alcolica",
          img: require("../assets/1.png")
        },
        {
          title: "2. Distanza di sicurezza ",
          text:
            "Evita contatti ravvicinati mantenedo la distanza di almeno un metro!",
        ...
        {
          title: "4.",
          text: "Non toccarti occhi, naso e bocca con le mani",
